...
public class Admin2 extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.badmin:
			...
			String c=rd.getpass(1);
			            ...
			            {
			            	Toast t=Toast.makeText(Admin2.this, "Successful Login"
			    					, Toast.LENGTH_LONG);
			    		           	t.show();
			    		           	Intent a=new Intent(Admin2.this,ViewandUpdate.class);
		                              startActivity(a);
			            ...
			            {
			            	Toast t=Toast.makeText(Admin2.this, "Incorrect password!!"
			    					, Toast.LENGTH_LONG);
			    		           	t.show();
